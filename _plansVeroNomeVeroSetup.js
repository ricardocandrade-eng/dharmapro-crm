...
function _atualizarPlanosVeroJsonRev9() {
  ...
  var MAPA = {
    ...
    'VERO MAIS 800MB + DISNEY+ ADS + HBO MAX ADS + MÓVEL 30GB': 'VERO DUO 800MB + DISNEY+ COM ANÚNCIO + HBO MAX COM ANÚNCIO + MAIS CONECTADO 30GB',
    'VERO MAIS 800MB + PRIME VIDEO + APPLE TV + MÓVEL 30GB': 'VERO DUO 800MB + PRIME VIDEO + APPLE TV + MAIS CONECTADO 30GB',
    'VERO MAIS 800MB + PRIME VIDEO + APPLE TV + HBO MAX + GLP PREMIUM + MÓVEL 60GB': 'VERO MAIS FULL 800MB + PRIME VIDEO + APPLE TV + HBO + GLP PREMIUM + MAIS CONECTADO 60GB',
